...
@ApiStatus.Internal
public record PlayerSettings(boolean isEnabled, int boxThreshold, boolean showAllBoxes) {
    ...
    public PlayerSettings withEnabled(boolean isEnabled) {
        return new PlayerSettings(isEnabled, this.boxThreshold, this.showAllBoxes);
    }

    public PlayerSettings withBoxThreshold(int boxThreshold) {
        return new PlayerSettings(this.isEnabled, boxThreshold, this.showAllBoxes);
    }

    public PlayerSettings withShowAllBoxes(boolean showAllBoxes) {
        return new PlayerSettings(this.isEnabled, this.boxThreshold, showAllBoxes);
    }
}
